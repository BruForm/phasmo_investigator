...
class Player
{
    ...
    public function getNbInvestig(): ?int
    {
        return $this->nbInvestig;
    }

    public function setNbInvestig(int $nbInvestig): self
    {
        $this->nbInvestig = $nbInvestig;
